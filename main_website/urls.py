...
urlpatterns = [
    ...
    path('first_floor/room1/',views.first_floor_link1,name="first_floor_link1"),
    path('first_floor/room2/',views.first_floor_link2,name="first_floor_link2"),
    path('first_floor/room3/',views.first_floor_link3,name="first_floor_link3"),
