...
class OrganizerDetails(models.Model):
	...
	unique_code = models.TextField(default="None")
...
class Stalls(models.Model):
	...
	stall_contact_url = models.FileField(null=True,blank=True)
	stall_schedule_url = models.FileField(null=True,blank=True)
